...
// 3. SerpAPI (3 veces al mes por el cron, respeta el límite gratuito)
if (SERPAPI_KEY) {
  try {
...
// 4. Guardar JSON para el frontend
const output = {
...
console.log(`✅ JSON actualizado: ${allOpportunities.length} oportunidades → ${OUTPUT_PATH}`);

// 5. También persistir en Supabase si está configurado
