          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">
                Analizá tu CV y descubrí oportunidades globales que aumentan tus posibilidades de empleo.
              </p>
              ...
              {/* BOTÓN WA AGRESIVO — directo a conversión */}
              <div className="flex justify-center">
                <a
                  href={`${WA_BASE}?text=${encodeURIComponent('Hola! Tengo una consulta sobre CVitae')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 bg-[#25d366] hover:bg-[#1db954] text-white font-bold px-6 py-3 rounded-full transition-all shadow-[0_0_20px_rgba(37,211,102,0.25)] hover:shadow-[0_0_30px_rgba(37,211,102,0.4)] hover:scale-105"
                >
                  ...
                  ¿No entendés algo? Escribinos — no molesta
                </a>
              </div>

              {/* SOCIAL PROOF bajo el hero */}
              <p className="text-xs text-gray-600 mt-4">
                🔒 Sin registro · Diagnóstico gratuito en 60 segundos · +500 paraguayos ya consiguieron entrevistas
              </p>
            </motion.div>
          </div>
        </div>
